...
export default function BoothPenjualanPage() {
    ...
    return (
        <div className="space-y-6 pb-24">
            ...
            {/* Submit Section - Sticky at bottom of content */}
            <div className="sticky bottom-0 p-4 bg-white/95 backdrop-blur-sm border-t border-slate-200 -mx-4 sm:-mx-6 px-4 sm:px-6 rounded-b-lg shadow-lg">
