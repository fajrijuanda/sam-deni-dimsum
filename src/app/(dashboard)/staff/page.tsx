    ...
    return (
        <div className="space-y-6 pb-20 md:pb-6">
            ...
            <div>
                ...
                <p className="text-slate-500 mt-1">Staff Produksi - Pantau stok harian</p>
            </div>
            ...
            <GlassCard className="p-4 bg-white border border-slate-200">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <Link href="/staff/stok" className="text-sm text-red-600 hover:underline flex items-center gap-1">
